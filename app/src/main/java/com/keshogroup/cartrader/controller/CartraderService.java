...
public class CartraderService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        boolean canUseBackgroundData = cm.getBackgroundDataSetting();
        boolean isNetworkActive = cm.getActiveNetworkInfo() != null;
        if (!canUseBackgroundData || !isNetworkActive) {
            return;
        }
        ...
        createNotification(array, gotaction, code, length, canUseBackgroundData, isNetworkActive);

    }//end of on Handle

    private void createNotification(String[] array, String gotaction, int code, int length, boolean networkready1, boolean networkready2) {
        Notification notice;
        Builder noticebuilder = new Builder(this);
        String str = " " + networkready1 + networkready2 + gotaction;
        ...
        noticebuilder.setContentText(gotaction);
        ...
        Log.i(TAG, "code" + code + ", length= " + length + ", responsecode= " + gotaction + ", output" + gotaction);
